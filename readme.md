...
`sudo wget http://www.tinycorelinux.net/14.x/x86_64/tcz/file.tcz   sudo wget http://www.tinycorelinux.net/14.x/x86_64/tcz/liblzma.tcz   
...
`# Compile your C++ binary (in WSL/Ubuntu) 
`cd ~/tinycore-remaster    
